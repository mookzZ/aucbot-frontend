      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: '16px' }}>
        ...
        {!loading && alerts.length === 0 && (
          <div style={{
            ...
            justifyContent: 'center', height: '200px', gap: '12px', color: 'var(--text-3)',
          }}>
              ...
              <div key={alert.id} style={{
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <div style={{
                    ...
                    borderRadius: '4px', padding: '3px 8px', marginTop: '6px',
                  }}>
                    <span style={{ fontSize: '10px', color: 'var(--text-3)', letterSpacing: '0.05em' }}>ЛИМИТ</span>
                    <span style={{ fontSize: '12px', fontWeight: 700, color: 'var(--accent)' }}>
                      {formatPrice(alert.price_limit)} ₽
                    </span>
                  </div>
                </div>
                <button
                  ...
                  style={{
                    ...
                    background: deleting === alert.id ? 'var(--bg-4)' : 'var(--danger-dim)',
